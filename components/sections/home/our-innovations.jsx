  ...
  const list = [
    {
      ...
      para: "Highlight Unique Selling Propositions with a short summary of the key feature and how it benefits customers.",
      url: "#",
      ...
      <div className="container">
        <div className="innovations-wrapper grid grid-cols-1 md:grid-cols-2 items-center">
          ...
          <div className="inn-text md:p-8">
            ...
            <p className="my-6">
              We offer a wide range of services including land development,
              residential spaces, and commercial premises. Whether you're
              looking to buy, we have the expertise to help you achieve your
              real estate goals.
            </p>
              ...
              {list.map((elem, ind) => (
                <div className="list-box flex items-start gap-3" key={ind}>
                  ...
                  <div className="list-text manrope">
                    <h4 className="manrope font-bold list-text-heading relative">{elem.title}</h4>
                    <p className="small-para manrope pt-6 pb-4">{elem.para}</p>
                    <Link href={elem.url} className="manrope text-sm">Learn More</Link>
                  </div>
                </div>
              ))}
            </div>
